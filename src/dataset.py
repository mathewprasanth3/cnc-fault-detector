...
def load_data(path="data/ai4i2020.csv", test_size=0.2, val_size=0.1, random_state=42):
    ...
    # Remove identifiers and individual failure modes to prevent data leakage
    ...
    # Stratified split to maintain failure ratio across sets
    ...
    # Save scaler for production inference (predict.py)
